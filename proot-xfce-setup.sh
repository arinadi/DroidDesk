...
echo "[+] Starting XFCE4 session in Proot distro: $PROOT_DISTRO"
echo "[+] Ensure Termux-X11 on :1 is already running."
proot-distro login "$PROOT_DISTRO" --shared-tmp $BINDS -- /bin/bash -lc '
    export DISPLAY=:1
    export TMPDIR=/tmp
